				...
				<div class="row">
					...
					<div class="center">
						...
						<div class="alert alert-danger alert-dismissable">
						 ...
						 <br><a class="btn btn-primary" href="${pageContext.request.contextPath}/login">Login</h5></a> with Another User .
						<div class="center_btn">
							<button class="btn btn-primary pull-right" onclick="goBack()">Back</button>
						</div>
					</div>
				</div>
				<!-- /.row -->
