	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">Your Orders are Successfully Submitted</h1>
					</div>
					<!-- /.col-lg-12 -->
				</div>
				<div>
				
				<p class="title">Your order has been successfully submitted. Your
				products will arrive in 3-5 business days. Thank you for shopping at
				E-Bazaar!</p>
			<br />
			<div class="row">
				<button onclick="window.location.href='${pageContext.servletContext.contextPath}'"
					class="btn btn-primary"> Continue Shopping</button> <button
				onclick="window.location.href='${pageContext.servletContext.contextPath}'"
					class="btn btn-primary"> Exit</button>
			</div>
				</div>
				<!-- /.row -->
			</div>
