		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-lg-12">
						<h1 class="page-header">Browse Catalog</h1>

						<div class="list-group">
							<c:forEach var="catalogPres" items="${catalogs}">

								<a class="list-group-item"
									href="${pageContext.servletContext.contextPath}/viewProductList/catalogId/${catalogPres.id }/catalogName/${catalogPres.name }">
									<i class="glyphicon glyphicon-shopping-cart"></i>
									${catalogPres.name  } <span class="pull-right text-muted small"><em></em>
								</a>
