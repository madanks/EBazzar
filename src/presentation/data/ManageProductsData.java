...
public class ManageProductsData {
	...
	public ProductPres createProductPres(String catName, int prodId, String name,
		...
		Catalog catalog = productSubsystem.getCatalogFromName(catName);
	...
	public ProductPres createProductPresByName(int prodId) throws BackendException{
		//ProductSubsystem pss = new ProductSubsystemFacade();
		Product prod = productSubsystem.getProductFromId(prodId);
		ProductPres prodPres = new ProductPres();
...
//	}
	...
	public ObservableList<CatalogPres> getCatalogList() throws BackendException {
		List<CatalogPres> list = browseAndSelectController.getCatalogs()
			    .stream()
...
//	}
	...
	public void deleteCatalog(int catalogId) {
		...
		manageProductsController.deleteCatalog(catalogId);
	}
	public void deleteProduct(int productId) {
		// TODO Auto-generated method stub
		manageProductsController.deleteProduct(productId);
	}
}
