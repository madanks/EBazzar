...
/**
 * This class is used to present customer name and address information in
 * tableviews. There is no corresponding entity class; instead it is a
 * combination of Address and CustomerProfile entities.
 *
 */
public class CustomerPres {
	...
	public String getName() {
		return custProfile.getFirstName() + " " + custProfile.getLastName();
	}
