...
public interface ShoppingCartSubsystem {
	...
	/**
	 * Empties the live cart. This needs to be done after an order has been
	 * submitted
	 */
	public void clearLiveCart();

	//
	// /**Used to display items currently in live shopping cart (for instance,
	// when an item is added to cart
	// * and the CartItemsWindow is about to be displayed). the method returns
	// the list of cart items currently
	...
	// public void makeSavedCartLive();
	//
	// /** used when user selects the "Save Cart" option on the cart items
	// window */
	...
	// */
	// public void runShoppingCartRules() throws RuleException,
	// BusinessException;
	//
	// /**
